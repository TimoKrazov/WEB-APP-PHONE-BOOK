    ...
    <div id="content">
        ...
        if (isset($_POST['input']) && $_POST['input'] == 'add') { // Добавление
            ...
            echo "<table align=\"center\">";
                    ...
                    // Для поля CountryID выводим выпадающий список
            echo "<tr>";
            ...
            echo "<tr><td>Введи телефонный код города: </td><td><input type=\"text\" maxlength=\"10\" size=\"70\" name=\"phone_city_code_add\"/></td></tr>";
            echo "</table>";
            echo "<p class=\"centr\">";
            echo "<br/>";
            ...
            if (!isset($_POST['chooseRow'])) {
                ...
                echo "<tr><td>Введи телефонный код города: </td><td><input type=\"text\" size=\"70\" maxlength=\"10\" name=\"phone_city_code_upd\" value=\"" . $line_content[3] . "\"/></td></tr>";
