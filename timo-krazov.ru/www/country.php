    ...
    <div id="content">
        ...
        if (isset($_POST['input'])) {
            if ($_POST['input'] == 'add') { // Добавление
                ...
                echo "<tr><td>Введи телефонный код страны: </td><td><input type=\"text\" size=\"70\" maxlength=\"10\" name=\"phone_country_code_add\"/></td></tr>";
                ...
                if (!isset($_POST['chooseRow'])) {
                    ...
                    echo "<tr><td>Введи телефонный код страны: </td><td><input type=\"text\" size=\"70\" maxlength=\"10\" name=\"phone_country_code_upd\" value=\"" . $line_content[1] . "\"/></td></tr>";
