...
<div id="container">
    ...
    <div id="content">
        ...
        if (isset($_POST['input']) && $_POST['input'] == 'add') { // Добавление
            ...
            echo "</select></td></tr>";
            echo "<tr><td>Введи номер телефона: </td><td><input type=\"text\" size=\"70\" maxlength=\"20\" pattern=\"[0-9()+]+\" oninput=\"this.value = this.value.replace(/[^0-9()+ -]/g, '')\" title=\"Разрешены 0-9,  (, ), +, -, \" name=\"number_phone_add\"/></td></tr>";
            echo "</table>";
            echo "<p class=\"centr\">";
            echo "<br/>";
            ...
            if (!isset($_POST['chooseRow'])) {
                ...
                echo "</select></td></tr>";
                echo "<tr><td>Введи номер телефона: </td><td><input type=\"text\" size=\"70\" maxlength=\"20\" pattern=\"[0-9()+]+\" oninput=\"this.value = this.value.replace(/[^0-9()+ -]/g, '')\" title=\"Разрешены 0-9,  (, ), +, -, \" name=\"number_phone_upd\" value=\"" . $line_content[2] . "\"/></td></tr>";
                echo "</table>";
                echo "<p class=\"centr\">";
                echo "<br/>";
                echo "<input type=\"submit\" name=\"submit\" value=\"Отправить\"/>";
