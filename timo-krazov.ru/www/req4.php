...
$query_content = "SELECT c.name_city, cn.name_country, cat.name_category, o.name_organization, nno.number_phone_organization 
                ...
                ORDER BY c.name_city, cat.name_category";
...
<div id="container">
    ...
    <div id="content">
        <h1>Список телефонов всех организаций</h1>
        <br/>
