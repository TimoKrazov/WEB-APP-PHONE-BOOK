...
Это необходимо для защиты от SQL-инъекций и вредоносного кода. */ 
 ...
 Cделан доступ для любого пользователя (user@%), с ораничением прав (только SELECT) */ 
    ...
    $stmt = $link->prepare("SELECT userid FROM user_autentificate WHERE username = ? AND password = ?");
...
<body> 
    ...
    <h1>Вход</h1> 
    <p class="centr"> 
    Введите следующие данные (Логин для user: trueuser Пароль для user: true): 
    </p> 
